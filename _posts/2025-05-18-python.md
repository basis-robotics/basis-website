...
Basis Units are loaded via `dlopen`, essentially as plugins.
```cpp
...
[^footnotes]: also - i discovered how to use footnotes for this post. hopefully i didn't go overboard.
