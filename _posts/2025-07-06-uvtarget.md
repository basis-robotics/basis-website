...
I've released today a tool uvtarget - used to link together multiple python projects into one workspace with a single lockfile, with CMake. [It's available here on GitHub](https://github.com/basis-robotics/uvtarget).
